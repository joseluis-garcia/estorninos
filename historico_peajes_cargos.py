...
@st.cache_data
def load_historico_peajes(estaciones=True, efemerides=True):
#==========================
...
#==========================
    ...
    df_clean = df_spot.drop_duplicates(subset=["date", "hour"], keep="first")
    #print("AAA", df_spot[df_spot.duplicated(subset=["date", "hour"], keep=False)].sort_values(["date","hour"]))
#==========================
# Prepara datos spot para heatmap
#==========================
    price_matrix = df_clean.pivot(index="date", columns="hour", values="peajes")
